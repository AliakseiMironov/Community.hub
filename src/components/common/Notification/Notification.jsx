...
const Notification = ({ type, message, actions, onClose }) => {
  const getTitle = () => {
    switch (type) {
      case "check_email":
        return "Проверьте почту!"; /*yes*/
      case "error":
        return "Ошибка!";/*yes*/
      case "success":
        return "Поздравляем!";/*yes*/
      case "saveNoData":
        return "Прекратить заполнение формы";/*yes*/
      case "saveDraft":
        return "Черновик мероприятия успешно сохранен!";/*yes*/
      case "warning":
        return "Внимание!";
      case "info":
        return "Информация";
