...
const EventRegistration = () => {
  ...
  const renderStep = () => {
    switch (step) {
      case 1:
        return <StepOne onNext={handleNext} formData={formData} setFormData={setFormData} />;
      case 2:
        return <StepTwo onNext={handleNext} onBack={handleBack} formData={formData} setFormData={setFormData} />;
      case 3:
        return <StepThree onNext={handleNext} onBack={handleBack} formData={formData} setFormData={setFormData} />;
      case 4:
        return <StepFour onSubmit={handleSave} onBack={handleBack} onCancel={handleCancel} formData={formData} setFormData={setFormData} />;
      default:
        return null;
    }
  };
        ...
        <div className="registration-main">
          <div className="registration-header">
            <h2 className="registration-title">
              {id ? `${formData.eventName}` : "Новое мероприятие"}
            </h2>
          </div>
