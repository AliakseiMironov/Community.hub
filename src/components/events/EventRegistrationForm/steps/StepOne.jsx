...
//       .test(
//          "participants-format",
//          "Количество участников должно быть числом",
//          function (value) {
//             if (!value) return true;
         ...
         <form className="step-form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-group">
               <div className="label-with-icon">
                  ...
                  <span
                     className="info-icon"
                     data-tooltip="Кратко опишите основные цели и задачи вашего мероприятия, его тематику, концепцию, отличительные черты и целевую аудиторию."
                  >
                     <svg
                        width="16"
                        height="16"
...
{/* =======
               ...
               <div
                  ...
                  onClick={() =>
                     !cardPreview &&
                     document.getElementById("cardBanner").click()
                  }
                  onDrop={(e) => handleDrop(e, "cardBanner")}
                  onDragOver={handleDragOver}
               >
                  <input
                     ...
                     style={{ display: "none" }}
                     onChange={(e) =>
                        handleImageChange(e, "cardBanner", setCardPreview)
                     }
                  />
                  {cardPreview ? (
                     <div className="file-upload-preview">
                     ...
                     <div className="file-upload-content">
                        <span>
                           Загрузить файл или перетащите сюда изображение
                        </span>
                        <span>PNG, JPG до 10Mb</span>
                        <span>мин. формат 420x256 px</span>
                     </div>
...
{/* =======
               ...
               <div
                  ...
                  onClick={() =>
                     !pagePreview &&
                     document.getElementById("pageBanner").click()
                  }
                  onDrop={(e) => handleDrop(e, "pageBanner")}
                  onDragOver={handleDragOver}
               >
                  <input
                     ...
                     style={{ display: "none" }}
                     onChange={(e) =>
                        handleImageChange(e, "pageBanner", setPagePreview)
                     }
                  />
                  {pagePreview ? (
                     <div className="file-upload-preview">
...
>>>>>>> origin/dev-irina */}
            ...
            <div className="form-row">
               ...
               <div className="form-col">
                  <div className="form-group">
                     <label htmlFor="eventFormat" required>
                        Формат мероприятия
                     </label>
                     <CustomSelect
                        options={eventFormatOptions}
               ...
               <div className="form-col">
                  <div className="form-group">
                     <div className="label-with-icon">
                        ...
                        <span
                           className="info-icon"
                           data-tooltip="Укажите максимальное количество участников, которые могут зарегистрироваться на мероприятие"
                        >
                           <svg
                              width="16"
                              height="16"
