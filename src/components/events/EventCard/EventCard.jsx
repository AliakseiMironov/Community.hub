...
const EventCard = ({ event }) => {
   ...
   const getMenuItems = (status) => {
      ...
      return menuItems.filter((item) =>
         item.showFor.includes(status || "draft")
      );
   };
   ...
   return (
      ...
      >
         <div
            ...
            style={{
               backgroundImage: event.cardBanner
                  ? `url(${event.cardBanner})`
                  : "none",
               backgroundColor: !event.cardBanner ? "#F5F5F5" : "transparent",
               filter: ["completed", "cancelled"].includes(event.status)
                  ? "grayscale(100%)"
                  : "none",
            }}
         >
            ...
            <div className="event-card__footer">
               <div className="event-card__community">
                  ...
                  >
                     ...
                     />
                     <path
                        d="M5.33333 8C5.33333 8.73638 5.93095 9.33333 6.66667 9.33333H9.33333C10.069 9.33333 10.6667 8.73638 10.6667 8C10.6667 7.26362 10.069 6.66667 9.33333 6.66667H6.66667C5.93095 6.66667 5.33333 7.26362 5.33333 8Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                     />
                  </svg>
